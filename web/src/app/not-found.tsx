    ...
    <>
      ...
      <main id="conteudo" className="relative overflow-hidden">
        <section className="container-luxe relative flex min-h-[90dvh] flex-col items-center justify-center pb-20 pt-32 text-center">
          <span
            className="pointer-events-none absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 select-none font-display text-[clamp(13rem,42vw,30rem)] leading-none text-ivory/[0.03]"
            aria-hidden
          >
            404
          </span>
          ...
          <h1 className="relative mt-6 max-w-3xl font-display text-[clamp(2.5rem,6.5vw,5rem)] leading-[1.02] text-ivory">
            Esta peça não está no <em className="italic text-foil">acervo</em>.
          </h1>
          <p className="relative mt-6 max-w-lg text-base leading-relaxed text-mist md:text-lg">
            O endereço pode ter mudado ou a página saiu da vitrine. Volte ao início ou siga direto para a coleção.
          </p>
